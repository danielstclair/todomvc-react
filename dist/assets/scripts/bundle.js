...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    var counter = 0;
    var completed = this.props.list.filter(function (item, i) {
    ...
    var fancyClass = counter === 0 ? 'hidden' : 'counter';
...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement('input', { className: 'todo-text', type: 'text', placeholder: 'filter', onKeyUp: this.itemFilter })
    );
  },
    ...
    var menuItems = this.props.menuItems.map(function (item, i) {
      return React.createElement(
        ...
        React.createElement(
          ...
          item.uid,
          ' ',
          React.createElement(Counter, { uid: item.uid, list: _this.props.list })
        )
      );
    });
    return React.createElement(
...
},{"./counter":1,"react":164,"react-dom":35}],4:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(Filter, { itemFilter: this.itemFilter, filter: this.state.filter }),
      React.createElement(
        'ul',
        null,
        listHTML
...
},{"./components/todo.js":5,"react":164,"react-dom":35}],7:[function(require,module,exports){
(function (process){
/**
